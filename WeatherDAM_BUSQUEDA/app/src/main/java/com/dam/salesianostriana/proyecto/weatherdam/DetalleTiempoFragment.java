...
public class DetalleTiempoFragment extends Fragment {
    ...
    ImageView imgTiempo, imgAmanecer,imgAnochecer,imgTempMax,imgTempMin,imgFav,imgHumedad;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imgFav = (ImageView) v.findViewById(R.id.imageViewFav);
    ...
    private class GetDataTask extends AsyncTask<Void, Void, OpenWeatherDaily> {
        ...
        protected OpenWeatherDaily doInBackground(Void... params) {
            ...
            String URL_REQUEST = "http://api.openweathermap.org/data/2.5/weather?q="+nombre_ciudad.replace(" ","").replace("España","Spain").trim()+"&units=metric&appid=3bcfcde9b7438aa7696f020ed75f5673&lang=es";
